...
module.exports.ctaphid_via_webauthn = async function ctaphid_via_webauthn(cmd, addr, data, timeout) {
  ...
  var keyhandle = module.exports.encode_ctaphid_request_as_keyhandle(cmd, addr, data);
  ...
  return window.navigator.credentials.get({
    ...
    let response = module.exports.decode_ctaphid_response_from_signature(assertion.response);
...
module.exports.encode_ctaphid_request_as_keyhandle = function encode_ctaphid_request_as_keyhandle(cmd, addr, data) {
    console.log('REQUEST CMD', cmd, '(', constants.command_codes[cmd], ')');
...
module.exports.decode_ctaphid_response_from_signature = function decode_ctaphid_response_from_signature(response) {
    ...
    return {
        ...
        status: constants.ctap_error_codes[error_code],
        data: data,
        signature: signature,
    };
}
